...
## The parentheses calls the function.
# What is the return value?
## 3

# TODO: What will the output of the following code be? Why? Explain step-by-step
type(max([1, 2, 3]))
## It will be int because the type function is operating on the return value of the max function which is already established as 3. 

# TODO: What will the output of the following code be? Why?
type(max)
## Function. Because the type function evaluates max as a function. 
